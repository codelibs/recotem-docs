...
- [Installation](/2.1/guide/installation) — pip and Docker setup, key generation
- [Tutorial](/2.1/guide/tutorial/) — end-to-end example with a real purchase log dataset
- [Recipe Basics](/2.1/guide/recipe-basics) — understand every section of a recipe file
- [CLI Reference](/2.1/guide/cli) — all six commands and their flags
