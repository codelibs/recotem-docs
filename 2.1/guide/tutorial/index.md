...
- [Recipe Basics](/2.1/guide/recipe-basics) — understand every section of a recipe in detail
- [CLI Reference](/2.1/guide/cli) — all flags for `train`, `serve`, and the other commands
- [Recipe Reference](/2.1/docs/recipe-reference) — full field-level documentation for every recipe field
- [Batch and Scheduling](/2.1/guide/batch) — run training on a cron schedule
