...
- [Deployment: Docker](/2.1/docs/deployment/docker) — production Docker patterns
- [Deployment: Kubernetes](/2.1/docs/deployment/kubernetes) — full Helm chart reference and rolling update guidance
- [Deployment: cron / systemd](/2.1/docs/deployment/cron-systemd) — detailed cron and wrapper-script patterns
- [Operations](/2.1/docs/operations) — key rotation, memory sizing, troubleshooting
