...
- [Installation](/2.0/guide/installation) — pip and Docker setup, key generation
- [Tutorial](/2.0/guide/tutorial/) — end-to-end example with a real purchase log dataset
- [Recipe Basics](/2.0/guide/recipe-basics) — understand every section of a recipe file
- [CLI Reference](/2.0/guide/cli) — all six commands and their flags
