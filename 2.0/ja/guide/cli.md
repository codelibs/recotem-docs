...
検証に失敗した場合、終了コードで何が問題かがわかります (レシピスキーマエラーは 2、データソースエラーは 3)。[終了コード](/2.0/ja/docs/exit-codes)を参照してください。
...
典型的な原因を含む完全な終了コードリファレンスについては [終了コード](/2.0/ja/docs/exit-codes) を参照してください。
