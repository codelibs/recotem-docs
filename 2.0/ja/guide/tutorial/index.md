...
- [レシピの基本](/2.0/ja/guide/recipe-basics) — レシピの各セクションを詳しく理解する
- [CLI リファレンス](/2.0/ja/guide/cli) — `train`、`serve` などのコマンドの全フラグ
- [レシピリファレンス](/2.0/ja/docs/recipe-reference) — すべてのレシピフィールドの詳細ドキュメント
- [バッチとスケジューリング](/2.0/ja/guide/batch) — cron スケジュールで学習を実行する
