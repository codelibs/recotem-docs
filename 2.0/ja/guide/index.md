...
- [インストール](/2.0/ja/guide/installation) — pip と Docker のセットアップ、鍵の生成
- [チュートリアル](/2.0/ja/guide/tutorial/) — 実際の購買ログデータセットを使ったエンドツーエンドの例
- [レシピの基本](/2.0/ja/guide/recipe-basics) — レシピファイルの各セクションを理解する
- [CLI リファレンス](/2.0/ja/guide/cli) — 全 6 コマンドとそのフラグ
