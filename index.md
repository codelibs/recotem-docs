...
features:
  ...
  - title: Friendly defaults
    details: Sensible defaults for splitting, evaluation, and hyperparameter tuning. Get from raw interactions to a working /v1/recipes/{name}:recommend endpoint in minutes.
