...
- [インストール](/2.2/ja/guide/installation) — pip と Docker のセットアップ、鍵の生成
- [チュートリアル](/2.2/ja/guide/tutorial/) — 実際の購買ログデータセットを使ったエンドツーエンドの例
- [レシピの基本](/2.2/ja/guide/recipe-basics) — レシピファイルの各セクションを理解する
- [CLI リファレンス](/2.2/ja/guide/cli) — 全 6 コマンドとそのフラグ
