...
For the full plugin authoring contract (class shape, `FetchContext`, testing, packaging, compatibility), see [Plugin Authoring](/2.2/docs/plugin-authoring).
